...
df.to_csv("djokovic_3.csv", index=False)

print(df)

# 1. SCRAPE STAT SECTION
# 2. METHOD TO STORE DATA (LONG/WIDE, HOW TO ORGANIZE DATA)
# 3. TURN INTO CSV FILE
# 4. TURN INTO FUNCTION
